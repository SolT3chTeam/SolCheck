    ...
    <div class="flex flex-row flex-wrap flex-grow mt-2">
        <div class="w-full md:w-1/2 p-3">
            ...
            <div class="bg-white border rounded shadow">
                ...
                <div class="p-5">
                    <div id="mapId" style="height: 120px; width:50%" class="leaflet-container leaflet-touch leaflet-fade-anim leaflet-grab leaflet-touch-drag leaflet-touch-zoom"></div>
                </div>
            </div>
            <!--/Graph Card-->
        </div>
